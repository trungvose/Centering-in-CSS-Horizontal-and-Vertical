...
To simply center text inside a block element is using: _text-align_
######HTML
```html
...
##### 2. Block element (div)
To horizontally center a block element (like <div>), use _margin: auto;_
######HTML
```html
...
##### 3. Vertical Anything
This is a bit more tricky, but with only _position: absolute_ and _2D transform_ we are able to align center vertically whatever we want, even if we don’t know its height
######HTML
```html
    <div class="wrap-col">
        <div class="text-wrap">
